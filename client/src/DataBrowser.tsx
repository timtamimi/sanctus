...
export default (props) => {
    ...
    const columns: Record<string, GridColDef[]> = {
        partners: [
            ...
            { field: 'expectedMonthlyUsage', headerName : 'Expected monthly usage', width : 150, type: 'number' },
            { field: 'sessionCount', headerName : 'Actual usage (January)', width : 150,type: "number" },
            { field: 'delta', headerName : 'Balance (January)', width : 150, type: "number" },
        ],
        coaches: [
    ...
    return  <Grid container spacing={2}>
        <Grid item xs={12}>
            ...
            >
                ...
                <ToggleButton value="coachees">
                    Coachees
                </ToggleButton>
                <ToggleButton value="partners">
                    Partners
                </ToggleButton>
        ...
        <Grid item xs={12}>
            <DataGrid rows={prepareDataForDataGrid(props[dataView])} columns={columns[dataView]} />
        </Grid>
    </Grid>
}